  ...
  return (
    <div className='bg-zinc-950 h-dvh  flex flex-col md:flex-row-reverse '>
      ...
      <div className='bg-zinc-950 flex-1 flex flex-col pb-24'>
        ...
        <div className='  flex-1 overflow-auto text-zinc-500 p-4 mx-4 '>
          <div className='flex justify-center flex-col  md:flex-row gap-8 mb-8 '>
            <div className='left-banner border flex-3 rounded-xl p-4 bg-zinc-900'>
              ...
              <div className='py-4'>
                <p className='text-sm'>
                  Accumulate points by mastering movements. Level up your
                  physical rank through consistency and intensity
                </p>
              </div>
